...
class DrunkenWalkEnv(discrete.DiscreteEnv):
    ...
    def __init__(self, desc=None, map_name="4x4", is_slippery=True):
        ...
        def construct_transition_for_intended(row, col, a, prob, li):
            """
            Constructs a transition to the "intended_destination(row, col, a)"
            ...
            for col in range(ncol):
                ...
                for a in range(4):
                    ...
                    if letter in b'G':
                        ...
                        #
                        # - But in gym, in practice, this case should not be happening at all!
                        ...
                        #   From gym's perspective we could specify anything we like here. E.g.,:
                        #       li.append((1.0, 59, 42000000, True))
                        #
                        # However, if we want to be able to use the transition matrix to do value iteration,
                        # it is important that we get 0 reward ever after.
